...
import { createAlbumTags } from "../graphql/mutations";
export default function AlbumTagsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createAlbumTags.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AlbumTagsCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
